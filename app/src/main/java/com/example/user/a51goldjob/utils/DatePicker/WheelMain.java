package com.example.user.a51goldjob.utils.DatePicker;
...
//		int day = calendar.get(Calendar.DATE);
		...
		// 年
		wv_year = (WheelView) view.findViewById(
				R.id.year);
		...
		// 月
		wv_month = (WheelView) view.findViewById(
				R.id.month);
	...
	public boolean isAfterCurrent(){
		...
		try {
			Date selectDate = df.parse(strDate);
			isAfter = selectDate.after(currentDate);
