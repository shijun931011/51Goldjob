...
public class PullToRefreshListView extends ListView implements OnScrollListener {
	...
	public void init(Context context, LinearLayout topView, View[] topChildViews) {
		...
		if (topView == null) {
			...
			if (ArrayUtils.isEmpty(topChildViews)) {
				...
				for (View topChildView : topChildViews) {
					linearLayout.addView(topChildView);
				}
		...
		arrowImageView.setMinimumHeight(200);
	...
	public void onRefreshComplete() {
		onRefreshComplete("最近更新:" + new Date().toLocaleString());
	}
