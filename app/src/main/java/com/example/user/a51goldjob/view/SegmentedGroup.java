...
public class SegmentedGroup extends RadioGroup {
    ...
    public void updateBackground() {
        ...
        if (count > 1) {
            ...
            updateBackground(getChildAt(0), R.drawable.seg_radio_checked_left, R.drawable.seg_radio_unchecked_left);
            for (int i = 1; i < count - 1; i++) {
                updateBackground(getChildAt(i), R.drawable.seg_radio_checked_middle, R.drawable.seg_radio_unchecked_middle);
            ...
            updateBackground(getChildAt(count - 1), R.drawable.seg_radio_checked_right, R.drawable.seg_radio_unchecked_right);
        } else if (count == 1) {
            updateBackground(getChildAt(0), R.drawable.seg_radio_checked_default, R.drawable.seg_radio_unchecked_default);
        }
    }
